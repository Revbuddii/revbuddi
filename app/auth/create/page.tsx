...
// @ts-expect-error
  ...
  return (
    <div className="min-h-screen flex items-center justify-center  bg-grid-sky-100/50">
      <Card className="w-full bg-white max-w-md  shadow-lg rounded-xl p-4">
        <CardHeader className="flex flex-col items-center space-y-2 pt-6 pb-4">
          ...
          <p className="text-sm text-gray-500">Please sign up using the form below</p>
        </CardHeader>
        <CardContent>
